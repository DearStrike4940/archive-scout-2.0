...
`2.0.0-alpha.2` is an alpha release. Keep backups of important projects and verify large media jobs with a narrow date range first.

See [ROADMAP.md](ROADMAP.md), [docs/OPERATIONS.md](docs/OPERATIONS.md), and [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md).
